...
namespace BattleShip_client
{
    public class Program
    {
        ...
        public static int SaisieTaille(string p)
        {
            bool isValid = false;
            int n;
        ...
        public static void JouerPartie(Socket sender)
        {
            while (_rematch)
            {
                ...
                int c = SaisieTaille("Nombre de colonnes ?");
                int l = SaisieTaille("Nombre de lignes ?");
                EnvoyerMessage(sender, partie.SerializeData($"{c}/{l}"));
                partie.StartGame(c, l);
